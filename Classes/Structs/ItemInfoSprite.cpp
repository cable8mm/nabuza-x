...
ItemInfoSprite::ItemInfoSprite(void) : itemKey(0), playerLevel(0) {
}
...
bool ItemInfoSprite::init() {
    //////////////////////////////
    // 1. super init first
    if (!ItemInfoSprite::initWithFile(
            "item_info.png", CCRect(0., 0., TEXTURE_SIZE_W, TEXTURE_SIZE_H))) {
        return false;
    }
...
void ItemInfoSprite::setItemKeyWithLevel(unsigned int itemKey,
