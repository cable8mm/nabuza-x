...
BuyJadeButtonSprite* BuyJadeButtonSprite::createWithItemKey(unsigned int key) {
    ...
    if (pobSprite && pobSprite->initWithFile("sale_btn_jade.png", CCRect(0., offsetY, TEXTURE_SIZE_W, TEXTURE_SIZE_H)))
    {
...
BuyJadeButtonSprite* BuyJadeButtonSprite::createWithItemKeyTapped(unsigned int key) {
    BuyJadeButtonSprite *pobSprite = new BuyJadeButtonSprite;
