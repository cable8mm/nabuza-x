...
TimeNabuzaGaugeSprite::TimeNabuzaGaugeSprite(void) : value(25) {
}
...
bool TimeNabuzaGaugeSprite::init() {
    //////////////////////////////
    // 1. super init first
    CCTexture2D *texture = CCTextureCache::sharedTextureCache()->textureForKey(
        "play_n_time_rainbow.png");
    if (!TimeNabuzaGaugeSprite::initWithTexture(
            texture, CCRect(0., 0., SIZE_WIDTH, SIZE_HEIGHT))) {
        return false;
    }
...
bool TimeNabuzaGaugeSprite::addValueFromRollingCount(
