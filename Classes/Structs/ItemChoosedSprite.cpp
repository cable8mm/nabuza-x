...
ItemChoosedSprite* ItemChoosedSprite::createWithKeys(int itemKey, unsigned int positionKey) {
    ...
    CCTexture2D *coinTexture  = CCTextureCache::sharedTextureCache()->textureForKey("item_box_btn.png");
    CCRect offset = CCRect(itemKey*TEXTURE_SIZE_W, 0., TEXTURE_SIZE_W, TEXTURE_SIZE_H);
