...
TimeGoldSprite::TimeGoldSprite(void)
:currentColor(0) {
}
...
TimeGoldSprite* TimeGoldSprite::createWithCustom()
{
    ...
    if (pobSprite && pobSprite->initWithFile("time_gold.png", CCRect(0.,0.,62.,61.)))
    {
...
void TimeGoldSprite::startAnimation() {
    CCAnimation *timeGoldWhiteEffectAnimation   = CCAnimationCache::sharedAnimationCache()->animationByName("time_gold_white_effect_animation");
    CCAnimate *timeGoldWhiteEffectAnimate = CCAnimate::create(timeGoldWhiteEffectAnimation);
    CCAnimation *timeGoldYellowEffectAnimation   = CCAnimationCache::sharedAnimationCache()->animationByName("time_gold_yellow_effect_animation");
    CCAnimate *timeGoldYellowEffectAnimate = CCAnimate::create(timeGoldYellowEffectAnimation);
    
    this->runAction( CCRepeatForever::create ( CCSequence::create(
                                                                  timeGoldYellowEffectAnimate
                                                                  ,CCCallFunc::create(this, callfunc_selector(TimeGoldSprite::toogleColor))
