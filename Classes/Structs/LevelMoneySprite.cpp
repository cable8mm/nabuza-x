...
LevelMoneySprite* LevelMoneySprite::createWithGoldCount(unsigned int goldCount) {
    ...
    if (pobSprite && pobSprite->initWithFile("level_icon_large.png", CCRect(level * TEXTURE_SIZE_W, 0., TEXTURE_SIZE_W, TEXTURE_SIZE_H)))
    {
