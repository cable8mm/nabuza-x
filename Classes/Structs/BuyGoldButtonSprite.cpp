...
BuyGoldButtonSprite* BuyGoldButtonSprite::createWithItemKey(unsigned int key) {
    ...
    if (pobSprite && pobSprite->initWithFile("sale_btn_gold.png", CCRect(0., offsetY, TEXTURE_SIZE_W, TEXTURE_SIZE_H)))
    {
...
BuyGoldButtonSprite* BuyGoldButtonSprite::createWithItemKeyTapped(unsigned int key) {
    BuyGoldButtonSprite *pobSprite = new BuyGoldButtonSprite;
