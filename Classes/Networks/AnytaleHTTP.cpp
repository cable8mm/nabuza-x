...
// 토근과 함께 URL 생성
std::string AnytaleHTTP::getUrlWithToken(std::string localUrl, std::string param) {
//    CCString *fullUrl   = CCString::createWithFormat("%s",HTTP_SERVER_URL);
...
void AnytaleHTTP::onHttpRequesting(CCObject* pTarget, SEL_CallFuncND pSelector, std::string url, std::string param, std::string tag) {
...
void AnytaleHTTP::onHttpRequestingWithoutToken(CCObject* pTarget, SEL_CallFuncND pSelector, std::string url, std::string param, std::string tag) {
    std::ostringstream oss;
...
//int AnytaleHTTP::validateResponse(CCHttpResponse *response, Json::Value &root) {
//    Json::Reader reader;
//    
////    CCDictionary *result;
//    
...
void AnytaleHTTP::validateResponse(CCHttpResponse *response, Json::Value &root, int &error) {
    CCLog("AnytaleHTTP::validateResponse(CCHttpResponse *response, Json::Value &root, int &error)");
    Json::Reader reader;
