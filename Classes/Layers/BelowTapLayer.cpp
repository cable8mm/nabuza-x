...
BelowTapLayer::BelowTapLayer() : touchedSprite(NULL), isGameStart(false) {
}
...
void BelowTapLayer::onEnter() {
    ...
    /*
     ...
     CCSpriteFrame* btnBelowGoldFrame   =
     CCSpriteFrame::createWithTexture(btnBelowGoldTexture, CCRectMake(0.,
     0., 60., 72.)); CCSprite *btnBelowGoldSprite   =
     ...
     for (int i=0; i < 4; i++) {
     btnBelowGoldFrames->addObject(CCSpriteFrame::createWithTexture(btnBelowGoldTexture,
     CCRectMake(0, 72.*i, 60., 72.)));
     }
     CCAnimation* animationTableObject  =
     CCAnimation::createWithSpriteFrames(btnBelowGoldFrames, .2f); CCAnimate*
     animateTableObject = CCAnimate::create(animationTableObject);
    ...
    //    this->addChild(btnBelowMenu2Sprite, ZORDER_BELOW_BUTTON,
    //    TAG_BELOW_GIFT_BUTTON);
    ...
    //    this->addChild(btnBelowMenu3Sprite, ZORDER_BELOW_BUTTON,
    //    TAG_BELOW_SETTING_BUTTON);
    ...
    //    this->addChild(btnBelowMenu4Sprite, ZORDER_BELOW_BUTTON,
    //    TAG_BELOW_INVITE_BUTTON);
    ...
    //    this->addChild(btnBelowMenu5Sprite, ZORDER_BELOW_BUTTON,
    //    TAG_BELOW_MESSAGE_BUTTON);
...
bool BelowTapLayer::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent) {
    ...
    CCSprite *belowEventButtonSprite =
        (CCSprite *)this->getChildByTag(TAG_BELOW_EVENT_BUTTON);
    if (belowEventButtonSprite->boundingBox().containsPoint(pt)) {
        //        AnytaleHTTP::onHttpRequesting(this,
        //        callfuncND_selector(BaseRankingLayer::onHttpRequestCompleted),
    ...
    CCSprite *belowGiftButtonSprite =
        (CCSprite *)this->getChildByTag(TAG_BELOW_GIFT_BUTTON);
    ...
    CCSprite *belowSettingButtonSprite =
        (CCSprite *)this->getChildByTag(TAG_BELOW_SETTING_BUTTON);
    ...
    CCSprite *belowInviteButtonSprite =
        (CCSprite *)this->getChildByTag(TAG_BELOW_INVITE_BUTTON);
    ...
    CCSprite *belowMessageButtonSprite =
        (CCSprite *)this->getChildByTag(TAG_BELOW_MESSAGE_BUTTON);
