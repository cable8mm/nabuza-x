...
bool TopJadeGoldLayer::init()
{
    ...
    CCNotificationCenter::sharedNotificationCenter()->addObserver(this, callfuncO_selector(TopJadeGoldLayer::onBuyJadeLayer), "ON_BUY_JADE_LAYER_NOTIFICATION", NULL);
    // OWN_JADE_COUNT_CHANGED_NOTIFICATION
    CCNotificationCenter::sharedNotificationCenter()->addObserver(this, callfuncO_selector(TopJadeGoldLayer::onChangedJadeCount), "OWN_JADE_COUNT_CHANGED_NOTIFICATION", NULL);
    CCNotificationCenter::sharedNotificationCenter()->addObserver(this, callfuncO_selector(TopJadeGoldLayer::onChangedGoldCount), "OWN_GOLD_COUNT_CHANGED_NOTIFICATION", NULL);
...
void TopJadeGoldLayer::onEnter()
{
    ...
    std::string s1   = UserStorage::sharedUserStorage()->getOwnJadeCount()->getCString();
    ATUtil::insert_separator(s1);
    CCLabelTTF *jewelSpriteLabel    = CCLabelTTF::create(s1.c_str(), DEFAULT_FONT_NAME, 18);
    ...
    //    CCScale9Sprite *btnJewelSprite  = CCScale9Sprite::create("jewel_mini_btn.png");
    //    btnJewelSprite->setCapInsets(CCRect(61., 20., 53., 22.));
    //    std::string s1   = UserStorage::sharedUserStorage()->getOwnJadeCount()->getCString();
    //    ATUtil::insert_separator(s1);
    //    CCLabelTTF *numberJewelLabel    = CCLabelTTF::create(s1.c_str(), DEFAULT_FONT_NAME, 20);
    //
    //    CCControlButton *numberJewelButton  = CCControlButton::create(numberJewelLabel, btnJewelSprite);
    //    numberJewelButton->setPreferredSize(CCSize(156., 60.));
    //    numberJewelButton->setPosition(ccp(7. + 78., ATUtil::agy(8.) - 30.));
    //    this->addChild(numberJewelButton, ZORDER_TOP_JADE_BUTTON, TAG_TOP_JADE_BUTTON);
    ...
    std::string s2   = UserStorage::sharedUserStorage()->getOwnGold()->getCString();
    ATUtil::insert_separator(s2);
    CCLabelTTF *goldSpriteLabel    = CCLabelTTF::create(s2.c_str(), DEFAULT_FONT_NAME, 18);
    ...
    //    CCScale9Sprite * btnGoldSprite  = CCScale9Sprite::create("gold_btn.png");
    //    btnGoldSprite->setCapInsets(CCRect(63., 20., 121., 22.));
    //    std::string s2   = UserStorage::sharedUserStorage()->getOwnJadeCount()->getCString();
    //    ATUtil::insert_separator(s2);
    //    CCLabelTTF *numberGoldLabel    = CCLabelTTF::create(s2.c_str(), DEFAULT_FONT_NAME, 20);
    //
    //    CCControlButton *numberGoldButton  = CCControlButton::create(numberGoldLabel, btnGoldSprite);
    //    numberGoldButton->setPreferredSize(CCSize(224., 60.));
    //    numberGoldButton->setPosition(ccp(238. + 112., ATUtil::agy(11.) - 30.));
    //    this->addChild(numberGoldButton, ZORDER_TOP_GOLD_BUTTON, TAG_TOP_GOLD_BUTTON);
...
//    CCControlButton *numberJewelButton  = (CCControlButton *)this->getChildByTag(TAG_TOP_JADE_BUTTON);
//    CCAssert(numberJewelButton != NULL, "button is must not NULL");
//    
...
//    CCControlButton *numberGoldButton  = (CCControlButton *)this->getChildByTag(TAG_TOP_GOLD_BUTTON);
...
void TopJadeGoldLayer::onChangedJadeCount(CCObject *obj) {
    ...
    CCSprite *jewelSprite   = (CCSprite *)this->getChildByTag(TAG_TOP_JADE_BUTTON);
    CCLabelTTF *jewelLabel  = (CCLabelTTF *)jewelSprite->getChildByTag(TAG_TOP_JADE_LABEL);
...
void TopJadeGoldLayer::onChangedGoldCount(CCObject *obj) {
    ...
    CCLabelTTF *goldLabel  = (CCLabelTTF *)goldSprite->getChildByTag(TAG_TOP_GOLD_LABEL);
